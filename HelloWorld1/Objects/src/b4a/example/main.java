...
mostCurrent._activity.LoadLayout("Layout",mostCurrent.activityBA);
 //BA.debugLineNum = 33;BA.debugLine="Activity.Title = \"Title\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Title"));
...
_xui.MsgboxAsync(processBA,BA.ObjectToCharSequence("Hello world!"),BA.ObjectToCharSequence("B4X"));
 //BA.debugLineNum = 47;BA.debugLine="Label1.Text = \"Hello World !\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("Hello World !"));
