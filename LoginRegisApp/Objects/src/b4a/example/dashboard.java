...
mostCurrent._activity.LoadLayout("dashboard",mostCurrent.activityBA);
 //BA.debugLineNum = 24;BA.debugLine="Activity.Title = \"Dashboard\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Dashboard"));
 //BA.debugLineNum = 25;BA.debugLine="Activity.AddMenuItem(\"Logout\", \"Logout\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Logout"),"Logout");
...
public static String  _logout_click() throws Exception{
 //BA.debugLineNum = 41;BA.debugLine="Sub Logout_Click()";
 //BA.debugLineNum = 43;BA.debugLine="Main.manager.SetBoolean(\"is_login\", False)";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 49;BA.debugLine="ToastMessageShow(\"Logout berhasil\", False)";
